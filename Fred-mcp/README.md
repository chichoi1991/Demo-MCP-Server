...
> **Copilot Studio 연결은 [COPILOT_STUDIO_SETUP.md](COPILOT_STUDIO_SETUP.md)를 참고하세요.**
...
| `WPUSI019011` | PPI: 구리 및 구리 제품 | 전선·모터·PCB 등 핵심 원자재 |
...
| `CUSR0000SAD` | CPI: 내구재 (1982-84=100) | 내구재 제품 가격 동향 |
